...
Remove-Module Monitoring.ActiveDirectory -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\Monitoring.ActiveDirectory.psd1"
Import-Module "$PSScriptRoot\..\Monitoring.ActiveDirectory.psm1" -Force
