<#
	.SYNOPSIS
		Installs the Monitoring.ActiveDirectory Module from github
		
	.DESCRIPTION
		This script installs the Monitoring.ActiveDirectory Module from github.
...
$ModuleName = "Monitoring.ActiveDirectory"

# Base path to the github repository
$BaseUrl = "https://github.com/<InsertUsernameHere>/Monitoring.ActiveDirectory"

# If the module is in a subfolder of the cloned repository, specify relative path here. Empty string to skip.
$SubFolder = "Monitoring.ActiveDirectory"
